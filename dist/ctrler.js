...
const ctrler = {
    create(opt) {
        const _this = this;
        const controllers = {};
        const findError = function (code) {
            return result.error.list.find((e) => {
        ...
        const result = {
            controller: {
                ...
                remove: (name) => result.controller,
                axios: undefined,
                get list() { return Object.keys(controllers); }
            },
            error: {
                add: () => true,
                remove: () => { },
        ...
        const controllerAdd = function (caOpt) {
            ...
            if (!_this.utils.isFunction(caOpt.action)
        ...
        const controllerRemove = function (name) {
    ...
    utils: {
        ...
        isObject: (fn) => typeof (fn) === 'object'
    }
};
/* harmony default export */ const lib = (ctrler);
...
/* harmony default export */ const main = (lib);
...
//# sourceMappingURL=ctrler.js.map